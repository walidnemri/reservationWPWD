...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getDoctrine_FixturesLoadCommandService()
    {
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AgentFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\ArtistFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\ArtistTypeFixtures(), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\ArtistTypeShowFixtures(), 'groups' => []], 5 => ['fixture' => new \App\DataFixtures\LocalityFixtures(), 'groups' => []], 6 => ['fixture' => new \App\DataFixtures\LocationFixtures(), 'groups' => []], 7 => ['fixture' => new \App\DataFixtures\RepresentationFixtures(), 'groups' => []], 8 => ['fixture' => new \App\DataFixtures\ReservationFixtures(), 'groups' => []], 9 => ['fixture' => new \App\DataFixtures\RoleFixtures(), 'groups' => []], 10 => ['fixture' => new \App\DataFixtures\ShowFixtures(), 'groups' => []], 11 => ['fixture' => new \App\DataFixtures\TypeFixtures(), 'groups' => []], 12 => ['fixture' => new \App\DataFixtures\UserFixtures(($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService())), 'groups' => []], 13 => ['fixture' => new \App\DataFixtures\UserRoleFixtures(), 'groups' => []]]);
