...
class App_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.ZBkcTvk' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_ZBkcTvkService()
    {
        return $this->privates['.service_locator.ZBkcTvk'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    protected function getConsole_Command_FormDebugService()
    {
        ...
        $this->privates['console.command.form_debug'] = $instance = new \Symfony\Component\Form\Command\DebugCommand(($this->privates['form.registry'] ?? $this->getForm_RegistryService()), [0 => 'Symfony\\Component\\Form\\Extension\\Core\\Type', 1 => 'App\\Form', 2 => 'Symfony\\Bridge\\Doctrine\\Form\\Type'], [0 => 'App\\Form\\LocalityType', 1 => 'App\\Form\\ReservationType', 2 => 'App\\Form\\User1Type', 3 => 'App\\Form\\UserType', 4 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\FormType', 5 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\ChoiceType', 6 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\FileType', 7 => 'Symfony\\Bridge\\Doctrine\\Form\\Type\\EntityType'], [0 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\TransformationFailureExtension', 1 => 'Symfony\\Component\\Form\\Extension\\HttpFoundation\\Type\\FormTypeHttpFoundationExtension', 2 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\FormTypeValidatorExtension', 3 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\RepeatedTypeValidatorExtension', 4 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\SubmitTypeValidatorExtension', 5 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\UploadValidatorExtension', 6 => 'Symfony\\Component\\Form\\Extension\\Csrf\\Type\\FormTypeCsrfExtension', 7 => 'Symfony\\Component\\Form\\Extension\\DataCollector\\Type\\DataCollectorTypeExtension'], [0 => 'Symfony\\Component\\Form\\Extension\\Validator\\ValidatorTypeGuesser', 1 => 'Symfony\\Bridge\\Doctrine\\Form\\DoctrineOrmTypeGuesser'], ($this->privates['debug.file_link_formatter'] ?? $this->getDebug_FileLinkFormatterService()));
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.ZBkcTvk'] ?? $this->get_ServiceLocator_ZBkcTvkService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
    ...
    protected function getDoctrine_FixturesLoadCommandService()
    {
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\ArtistFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\ArtistTypeFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\ArtistTypeShowFixtures(), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\LocalityFixtures(), 'groups' => []], 5 => ['fixture' => new \App\DataFixtures\LocationFixtures(), 'groups' => []], 6 => ['fixture' => new \App\DataFixtures\RepresentationFixtures(), 'groups' => []], 7 => ['fixture' => new \App\DataFixtures\ReservationFixtures(), 'groups' => []], 8 => ['fixture' => new \App\DataFixtures\RoleFixtures(), 'groups' => []], 9 => ['fixture' => new \App\DataFixtures\ShowFixtures(), 'groups' => []], 10 => ['fixture' => new \App\DataFixtures\TypeFixtures(), 'groups' => []], 11 => ['fixture' => new \App\DataFixtures\UserFixtures(), 'groups' => []], 12 => ['fixture' => new \App\DataFixtures\UserRoleFixtures(), 'groups' => []]]);
