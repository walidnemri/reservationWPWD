...
class __TwigTemplate_fa830adb4b7d04426643d31f118443edb162ae468c2582e84dc36027cac21e60 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 24
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["reservation"]) || array_key_exists("reservation", $context) ? $context["reservation"] : (function () { throw new RuntimeError('Variable "reservation" does not exist.', 24, $this->source); })()), "representation", [], "any", false, false, false, 24), "schedule", [], "any", false, false, false, 24), "H:i"), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Places</th>
                <td>";
        // line 28
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["reservation"]) || array_key_exists("reservation", $context) ? $context["reservation"] : (function () { throw new RuntimeError('Variable "reservation" does not exist.', 28, $this->source); })()), "places", [], "any", false, false, false, 28), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
...
{% endblock %}
", "reservation/show.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/reservationsWPWD/templates/reservation/show.html.twig");
    }
}
