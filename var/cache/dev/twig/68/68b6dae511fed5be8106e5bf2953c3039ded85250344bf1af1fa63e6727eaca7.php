...
class __TwigTemplate_95733cf53bc3146b715f1001a5e9ba7205bbcb0abd9473fa2e49951dea4f0528 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["roles"]) || array_key_exists("roles", $context) ? $context["roles"] : (function () { throw new RuntimeError('Variable "roles" does not exist.', 10, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["role"]) {
            // line 11
            echo "        <li>";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["role"], "role", [], "any", false, false, false, 11), "html", null, true);
            echo "</li>
    ";
        }
...
{% endblock %}
", "role/index.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/reservationsWPWD/templates/role/index.html.twig");
    }
}
