...
/* user/show.html.twig */
class __TwigTemplate_4502bc261e51badb42cd76fc1a1b8d1c26dda7d32c6e99e2138c029abd821930 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 36
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 36, $this->source); })()), "langue", [], "any", false, false, false, 36), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
...
{% endblock %}
", "user/show.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/reservationsWPWD/templates/user/show.html.twig");
    }
}
