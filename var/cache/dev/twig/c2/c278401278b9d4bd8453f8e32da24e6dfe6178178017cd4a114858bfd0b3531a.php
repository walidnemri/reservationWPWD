    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            ...
            echo "</td>
                <td>";
            // line 30
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["user"], "langue", [], "any", false, false, false, 30), "html", null, true);
            echo "</td>
                <td>
                    <a href=\"";
            // line 32
...
{% endblock %}
", "user/index.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/reservationsWPWD/templates/user/index.html.twig");
    }
}
